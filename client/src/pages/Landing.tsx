  ...
  return (
    <div className="flex flex-col items-center justify-center text-center p-8">
      ...
      <p className="text-lg mb-6">
        A browser-based IDE with support for more than 40 languages. Create,
        compile, and run your code effortlessly.
      </p>
      <div className="mb-6">
        <img
      ...
      <div className="flex space-x-2">
        ...
        <Button
          ...
          className="bg-green-600 text-white px-4 py-2 rounded-lg shadow hover:bg-green-500"
        >
          Go to Playground
        </Button>
      </div>
